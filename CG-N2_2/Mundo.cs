...
namespace gcgcg
{
    class Mundo : GameWindow
    {
        ...
        private void BuildQuadradoComPontosDeControle() 
        {
            ...
            this.spline = new Spline("F", new Ponto4D(100.0, -100.0), new Ponto4D(100.0, 100.0), new Ponto4D(-100.0, 100.0), new Ponto4D( -100.0, -100.0), 2, Color.Yellow);
        ...
        {
            this.spline.AdicionarPonto();
        }

        public void DiminuirPontosSpline()
        {
            this.spline.RemoverPonto();
        }
